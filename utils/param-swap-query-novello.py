...
def main(args):
    ...
    query_tf_filename = "/home/muntean/tfs-per-qid/all-matches-fields-tfs-qid-"+queryid+"-filtered.txt"
    qrel_filename = "/home/muntean/qrels-per-query/wt-query-"+queryid+".qrels"
    output_file = "/home/muntean/tfs-per-qid/trec-eval-all-weights-qid-"+queryid+".txt"
